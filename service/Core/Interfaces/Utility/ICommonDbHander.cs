...
namespace service.Core.Interfaces.Utility
{
    ...
    public interface ICommonDbHander
    {
        ...
        Task<BaseResponse> AddDataReturnLatestId(string? query, string? succMsg, string? errMsg, string? duplicateRecordError, string? errorCode, string? txn, object? param = null, string? logType = null);
        ...
        /// <param name="logType">The log type.</param>
        /// <returns>A task representing the asynchronous operation, containing a BaseResponse object.</returns>
        Task<BaseResponse> AddUpdateDeleteData(string? query, string? succMsg, string? errMsg, string? duplicateRecordError, string? errorCode, string? txn, object? param = null, string? logType = null);
        ...
        Task<List<T>> GetData<T>(string? query, string? succMsg, string? errMsg, string? errorCode, string? txn, object? param = null, string? logType = null);
        ...
        Task<T> GetSingleData<T>(string? query, string? succMsg, string? errMsg, string? errorCode, string? txn, object? param = null, string? logType = null);
    }
}
